...
#+INFOJS_OPT: view:overview toc:nil ltoc:t mouse:underline buttons:nil path:http://orgmode.org/org-info.js
...
infrastructre (you can find more background and updates on the [[http://www.lshift.net/blog/tag/feedshub][LShift blog]]).
...
subdirectory =plugins/acme_frotz= and two files in it.
...
******* The lifecycle of a plugin (*FIXME*: nuke that bit?)
